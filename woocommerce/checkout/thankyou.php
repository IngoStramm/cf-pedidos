...
if ( $order ) : ?>
    ...
    <?php do_action( 'woocommerce_thankyou', $get_order_id ); ?>
        ...
        <p class="success-color woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><strong><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', __( 'Obrigado, sua solicitação foi recebida.', 'cf-pedidos' ), $order ); ?></strong></p>
